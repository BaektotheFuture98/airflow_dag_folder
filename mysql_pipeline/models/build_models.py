...
def mysql_config(database: str, user: str, password: str, table: str | None = None) -> Dict[str, str]:
    return {"database": database, "user": user, "password": password, "table": table}
...
# def build_es_source_model(project_name : str, index: str, query : str, fields:str) -> dict:
#     from airflow.sdk import Variable
#     return {
#         "project_name" : project_name,
#         "query" : query, 
